...
# Move around:
sphero.setLEDColor(red=255, green=0, blue=255) # Turn main LED blue
sphero.setLEDColor(red=0, green=0, blue=200)
...
sphero.setLEDColor(red=0, green=255, blue=20)  # Turn main LED green
